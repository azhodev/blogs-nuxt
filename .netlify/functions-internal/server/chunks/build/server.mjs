import { hasInjectionContext, inject, reactive, isRef, unref, computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, toRef, nextTick, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, useSSRContext } from 'vue';
import { i as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, m as hash, s as sanitizeStatusCode, n as getContext, c as createError$1, e as destr, o as klona, p as parse, q as getRequestHeader, r as isEqual, t as setCookie, v as getCookie, x as deleteCookie, $ as $fetch, y as createHooks, z as executeAsync, A as toRouteMatcher, B as createRouter$1, C as defu, D as getRequestHeaders } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dva4Hg1M.mjs')
  },
  {
    name: "slug",
    path: "/:slug()",
    component: () => import('./_slug_-DUagb8kq.mjs')
  }
];
      ...
      if (serverQuery) {
        ...
        if (deduplication) {
          ...
          if (!observable) {
            ...
            observable = entry2.observable = concast_1;
...
const NuxtApollo = {
  ...
  clients: { "default": { "httpEndpoint": "https://blogs-strapi.onrender.com/graphql", "authType": "Bearer", "authHeader": "Authorization", "tokenName": "apollo:default.token", "tokenStorage": "cookie", "defaultOptions": void 0 } }
};
...
const prep = (...args) => {
  ...
  const key = args?.[0]?.key || hash({ query: print$1(query), variables: unref(variables), clientId });
...
function useApollo() {
  ...
  const getToken = async (client) => {
    ...
    return conf?.tokenStorage === "cookie" ? nuxtApp.runWithContext(() => useCookie(tokenName).value) : null;
  };
...
const plugin_l3RljX2AM_8iWaJgF8uMk1hyamzsKMXZof6WdqQxqC0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  plugin_l3RljX2AM_8iWaJgF8uMk1hyamzsKMXZof6WdqQxqC0
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-D-t0Y8Jz.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-2amswMjS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CrcjRcil.mjs'));
...
export { _export_sfc as _, useAsyncQuery as a, useRoute as b, useRouter as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
